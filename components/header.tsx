      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity flex-shrink-0">
            ...
            />
            <h1 className="text-lg sm:text-xl lg:text-2xl font-serif font-medium tracking-wide text-neutral-900 whitespace-nowrap">
              ...
              <div key={item.href} className="relative">
                {item.items ? (
                  <div className="relative">
                    <button
                      className={cn(
                        "flex items-center gap-1 px-2 xl:px-4 py-2 text-xs xl:text-sm font-medium tracking-wide text-neutral-900 hover:text-emerald-800 transition-colors uppercase",
                  ...
                  <Link
                    href={item.href}
                    className={cn(
                      "px-2 xl:px-4 py-2 text-xs xl:text-sm font-medium tracking-wide text-neutral-900 hover:text-emerald-800 transition-colors uppercase",
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-4 flex-shrink-0">
            ...
            <Link href="/auth/login">
              <Button
                variant="ghost"
                className="text-neutral-900 hover:text-emerald-800 hover:bg-transparent font-medium tracking-wide uppercase text-xs xl:text-sm px-2 xl:px-4"
            ...
            <Link href="/auth/sign-up">
              <Button className="bg-emerald-800 text-white hover:bg-emerald-900 font-medium tracking-wide uppercase text-xs xl:text-sm px-4 xl:px-6">
                Get Started
              </Button>
            </Link>
          </div>
